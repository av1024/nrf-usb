...
## AVRLIB defs
#AVRLIB =/home/av/src/avr/include/avrlib
#AVRLIBSRC = uart2.c buffer.c
#AVRLIBOBJ = $(AVRLIBSRC:%.c=$(OBJDIR)/%.o)
...
#buffer.o : $(AVRLIB)/buffer.c $(AVRLIB)/buffer.h
...
#
#  -c avrisp -p atmega162 -P /dev/ttyUSB1 -b 9600 -e -U flash:w:test.hex
# Type: avrdude -c ?
...
HEXSIZE = $(SIZE) --target=$(FORMAT) $(TARGET).hex -C --mcu=$(MCU)
